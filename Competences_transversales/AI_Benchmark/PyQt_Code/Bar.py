...
class MyBar(QtWidgets.QWidget):
    def __init__(self, parent):
        ...
        self.title = QtWidgets.QLabel("IA Benchmark")
        ...
        self.title.setStyleSheet("""
            ...
            color: qlineargradient(x1:0, y:0, x2:0, y2:45, stop:0 rgba(243, 67, 105, 255), stop:1 rgba(63, 59, 146, 255));
            font-weight: bold;
        ...
        self.icon.setContentsMargins(5, 5, 5, 5)
