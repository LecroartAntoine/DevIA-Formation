...
class Ui_form_calculatrice(object):
    def setupUi(self, form_calculatrice):
        ...
        self.btn_modulo = QtWidgets.QPushButton(form_calculatrice)
        self.btn_modulo.setMinimumSize(QtCore.QSize(64, 64))
        self.btn_modulo.setMaximumSize(QtCore.QSize(64, 64))
        self.btn_eucl = QtWidgets.QPushButton(form_calculatrice)
        self.btn_eucl.setMinimumSize(QtCore.QSize(64, 64))
        self.btn_eucl.setMaximumSize(QtCore.QSize(64, 64))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setWeight(75)
        font.setBold(True)
        ...
        font.setWeight(75)
        font.setBold(True)
        self.btn_modulo.setFont(font)
        self.btn_modulo.setFlat(True)
        self.btn_modulo.setObjectName("btn_modulo")
        self.gridLayout.addWidget(self.btn_modulo, 2, 2, 1, 1)
        self.btn_eucl.setFont(font)
        self.btn_eucl.setFlat(True)
        self.btn_eucl.setObjectName("btn_eucl")
        self.gridLayout.addWidget(self.btn_eucl, 2, 1, 1, 1)
    ...
    def retranslateUi(self, form_calculatrice):
        ...
        self.btn_eucl.setText(QtWidgets.QApplication.translate("form_calculatrice", "DivE", None, -1))
        self.btn_modulo.setText(QtWidgets.QApplication.translate("form_calculatrice", "Modulo", None, -1))
